...
const AuthPage = () => {
  ...
  const { signInWithEmailPassword, signUpWithEmailPassword, signInWithEmail, isLoading, session, signInWithProvider } = useAuth();
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Button variant="outline" className="w-full" onClick={() => signInWithProvider('github')} disabled={isLoading}>
              <Github className="mr-2 h-4 w-4" />
              GitHub
            </Button>
            <Button variant="outline" className="w-full" onClick={() => signInWithProvider('google')} disabled={isLoading}>
