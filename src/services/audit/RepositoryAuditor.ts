    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert({
          ...
          file_results: result.fileResults as any,
          security_summary: result.securitySummary as any,
          quality_summary: result.qualitySummary as any,
          performance_summary: result.performanceSummary as any,
